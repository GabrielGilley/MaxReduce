...
USAGE="Usage: scalability-experiment.sh -s PYTHON_SCRIPT.py -b PATH_TO_BUILD_DIRECTORY -r PATH_TO_RESULTS_DIRECTORY -d PATH_TO_DATA_DIRECTORY -e NAME_OF_EXPERIMENT -n NODE_COUNT -ip CLIENT_ADDRESS"
