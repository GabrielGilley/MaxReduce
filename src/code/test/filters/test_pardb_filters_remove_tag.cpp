...
static const char* filter_name = "test_pardb_filters_remove_tag";
static const char* filter_done_tag = "test_pardb_filters_remove_tag:done";

void run_(const DBAccess *access) {
    dbkey_t search_key {2,4,4};

    access->remove_tag.run(&access->remove_tag, search_key, "to_remove");
