...
void ZMQAddress::precompute_strings_() {
    ...
    local_addr_os << "ipc:///tmp/elga.ipc." << ip << "@" << localnum_;
    ...
    local_pub_addr_os << "ipc:///tmp/elga.ipc." << ip << "@" << (localnum_+PUB_OFFSET);
    ...
    local_pull_addr_os << "ipc:///tmp/elga.ipc." << ip << "@" << (localnum_+PULL_OFFSET);
    local_pull_addr_ = local_pull_addr_os.str();

    std::ostringstream addr_str_os;
    addr_str_os << ip << "," << localnum_;
    addr_str_ = addr_str_os.str();
}
